...
extension HuggingFaceAPI {
    ...
    public func loadHuggingFaceToken() -> String? {
        let tokenPaths = [
            FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent(".cache/huggingface/token"),
            FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent(".huggingface/token")
        ]
