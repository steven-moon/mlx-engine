...
final class ModelDownloaderTests: XCTestCase {
    ...
    func testSearchModelsWithLimit() async throws {
        ...
        do {
            ...
            for model in models {
                let containsLlama = model.name.lowercased().contains("llama") || 
                                   model.hubId.lowercased().contains("llama") ||
        ...
        do {
            ...
            if mistralModels.count > 0 {
                ...
                for model in mistralModels {
                    let containsMistral = model.name.lowercased().contains("mistral") || 
        ...
        do {
            ...
            if smallModels.count > 0 {
                ...
                for model in smallModels {
                    let isSmall = model.isSmallModel || 
                                 model.hubId.lowercased().contains("0.5b") ||
    ...
    func testSearchModelsByQuantization() async throws {
        ...
        do {
            ...
            for model in fourBitModels {
                let isFourBit = model.quantization == "4bit" || 
                               model.hubId.lowercased().contains("4bit") ||
        ...
        do {
            ...
            for model in models {
                ...
                if let arch = testModel.architecture {
                    ...
                    XCTAssertTrue(["Qwen", "Llama", "Mistral", "Phi", "Gemma"].contains(arch), "Architecture should be a known type")
                }
            }
    ...
    func testErrorHandling() async {
        ...
        do {
            let models = try await downloader.searchModels(query: "invalid_query_that_should_not_exist_12345", limit: 1)
